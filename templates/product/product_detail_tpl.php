<section class="cover-detail">
	<div class="box-detail row">
		...
		<div class="info-detail col-md-7 col-sm-7">
			...
			<?php if (!empty($pro_detail['place_from'])) { ?>
				<div class="group-detail">
					<div class="place_from"><i class="fas fa-map-marker-alt mr-1"></i><?= $pro_detail['place_from'] ?></div>
				</div>
			<?php } ?>

			<?php if (!empty($pro_detail['date_tour'])) { ?>
				<div class="group-detail">
					<div class="date_tour"><i class="far fa-clock mr-1"></i><?= $pro_detail['date_tour'] ?></div>
				</div>
			<?php } ?>

			<?php if (!empty($pro_detail['date_from'])) { ?>
				<div class="group-detail">
					<div class="date_from"><i class="far fa-calendar mr-1"></i><?= date('d/m/Y', $pro_detail['date_from']) ?></div>
				</div>
			<?php } ?>

			<?php if (!empty($pro_detail['remain'])) { ?>
				<div class="group-detail">
					<div class="remain"><i class="far fa-user mr-1"></i><?= $pro_detail['remain'] ?></div>
				</div>
			<?php } ?>
	...
	<div class="detail-content py-3">
		<div class="title-content d-flex">
			<p class="active">Thông tin tour</p>
		</div>
