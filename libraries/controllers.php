<?php
	...
	switch($com)
	{
		case 'gioi-thieu': Route::get('static@static/static', 'about', _gioithieu); break;
		case 'san-pham': Route::get('product@product/product', 'product', _sanpham); break;
		case 'tin-tuc': Route::get('post@post/post', 'news', _tintuc); break;
		case 'video': Route::get('static@static/static', 'video', "Video"); break;
		case 'lien-he': Route::get('static@static/static', 'contact', _lienhe); break;
		case 'tim-kiem': Route::get('search@product/product', 'product', _ketquatimkiem); break;
		// case 'lang':
		// 	switch($lang)
		// 	{
		...
		case 'sitemap': include_once LIB."/sitemap.php"; exit();
		case 'index': Route::get('index@index', '', ''); break;
	}
